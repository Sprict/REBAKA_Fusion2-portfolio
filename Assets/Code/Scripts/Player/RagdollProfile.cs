...
namespace MyFolder.Scripts.Player
{
    ...
    public class RagdollProfile : ScriptableObject
    {
        ...
        [Tooltip("プレイヤー同士・一般オブジェクトを掴むFixedJointのbreakForce。低いほど早く壊れる。プレイヤー同士の引っ張り合いで体が歪む前に外れてほしい場合は下げる。")]
        [Min(0f)]
        public float genericGrabBreakForce = 1400f;

        [Tooltip("プレイヤー同士・一般オブジェクトを掴むFixedJointのbreakTorque。低いほど早く壊れる。プレイヤー同士の引っ張り合いで体が歪む前に外れてほしい場合は下げる。")]
        [Min(0f)]
        public float genericGrabBreakTorque = 1400f;
