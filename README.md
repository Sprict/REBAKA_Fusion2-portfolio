...
| カテゴリ | # | 内容 | リンク |
|---|---|------|--------|
| 同期の証拠 | 1 | 異なる2台の実機（Windows / mac）でのネットワーク同期 | <!-- TODO: 動画URL --> |
| 物理・インタラクション | 2 | プレイヤーアクション一覧（移動・ジャンプ・しゃがみ・掴み） | <!-- TODO: 動画URL --> |
| 物理・インタラクション | 3 | オブジェクトを振り回して投げる | <!-- TODO: 動画URL --> |
| 物理・インタラクション | 4 | 2人で重量オブジェクトを協力して引きずる（ホスト/クライアント両視点） | <!-- TODO: 動画URL --> |
| 物理・インタラクション | 5 | 2人で1つのオブジェクトを逆方向に引っ張り Joint が Break する | <!-- TODO: 動画URL --> |
| 物理・インタラクション | 6 | プレイヤー同士の掴み引っ張り合い（Joint Break による発散保護） | <!-- TODO: 動画URL --> |
| ネットワーク堅牢性 | 7 | クライアント切断→再接続 | <!-- TODO: 動画URL --> |
| ネットワーク堅牢性 | 8 | ホスト切断→クライアントが Host/Join 選択へ安全復帰 | <!-- TODO: 動画URL --> |
| 開発者視点 | 9 | Gizmo・Collision 可視化状態のデバッグ画面 | <!-- TODO: 動画URL --> |
